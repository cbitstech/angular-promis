...
angular.module('urologySurvey.controllers', ['angularLocalStorage'])



.controller('CATAssessmentCtrl', function($scope, $http, storage, $rootScope ) {
  console.log('CAT Controller loaded.');
	...
	$scope.loadForm = function() {
			...
			$http.get('banks/Depression.json').success(function(data) {
				$scope.items = data.Items;
				console.log('CAT Controller loading items ' +   $scope.items.length);
				
				 $http.get('banks/Depression_Calibration.json').success(function(data) {
